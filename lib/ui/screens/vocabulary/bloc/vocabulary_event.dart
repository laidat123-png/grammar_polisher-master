...
class VocabularyEvent with _$VocabularyEvent {
  ...
  const factory VocabularyEvent.changeStatus(
      Word word, String? userDefinition) = _ChangeStatus;
  const factory VocabularyEvent.editDefinition(
      Word word, String? newDefinition) = _EditDefinition;
