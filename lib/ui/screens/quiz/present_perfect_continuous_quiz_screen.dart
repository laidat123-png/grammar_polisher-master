...
class PresentPerfectContinuousQuizScreen extends StatefulWidget {
  const PresentPerfectContinuousQuizScreen({super.key});

  @override
  State<PresentPerfectContinuousQuizScreen> createState() =>
      _PresentPerfectContinuousQuizScreenState();
}

class _PresentPerfectContinuousQuizScreenState
    extends State<PresentPerfectContinuousQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex <
          presentPerfectContinuousQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          presentPerfectContinuousQuestions[_currentQuestionIndex]
              .correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': presentPerfectContinuousQuestions.length,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${presentPerfectContinuousQuestions.length}',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${presentPerfectContinuousQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì hiện tại hoàn thành tiếp diễn dùng để diễn tả hành động bắt đầu trong quá khứ, tiếp tục đến hiện tại và có thể tiếp diễn trong tương lai. Cấu trúc: S + have/has + been + V-ing.',
                                      style: TextStyle(
