...
class PastPerfectQuizScreen extends StatefulWidget {
  const PastPerfectQuizScreen({super.key});

  @override
  State<PastPerfectQuizScreen> createState() => _PastPerfectQuizScreenState();
}

class _PastPerfectQuizScreenState extends State<PastPerfectQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < pastPerfectQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          pastPerfectQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': pastPerfectQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = pastPerfectQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${pastPerfectQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì quá khứ hoàn thành dùng để diễn tả hành động đã hoàn thành trước một thời điểm trong quá khứ. Cấu trúc: S + had + V3/ed. Thường đi với "before", "after", "by the time", "already", "just".',
                                      style: TextStyle(
