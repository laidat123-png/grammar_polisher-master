...
class NearFutureQuizScreen extends StatefulWidget {
  const NearFutureQuizScreen({super.key});

  @override
  State<NearFutureQuizScreen> createState() => _NearFutureQuizScreenState();
}

class _NearFutureQuizScreenState extends State<NearFutureQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < nearFutureQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          nearFutureQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': nearFutureQuestions.length,
      'quizDuration': quizDuration,
      'userAnswers': _userAnswers,
      'quizKey': 'near_future_quiz',
    };
  ...
  Widget build(BuildContext context) {
    final currentQuestion = nearFutureQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${nearFutureQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì tương lai gần dùng để diễn tả hành động sắp xảy ra trong tương lai gần. Cấu trúc: S + am/is/are + going to + V(nguyên thể). Thường đi với "soon", "in a minute", "this evening".',
                                      style: TextStyle(
