...
class PresentContinuousQuizScreen extends StatefulWidget {
  const PresentContinuousQuizScreen({super.key});

  @override
  State<PresentContinuousQuizScreen> createState() =>
      _PresentContinuousQuizScreenState();
}

class _PresentContinuousQuizScreenState
    extends State<PresentContinuousQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < presentContinuousQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          presentContinuousQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': presentContinuousQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = presentContinuousQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${presentContinuousQuestions.length}',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${presentContinuousQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì hiện tại tiếp diễn dùng để diễn tả hành động đang diễn ra tại thời điểm nói hoặc xung quanh thời điểm nói. Cấu trúc: S + am/is/are + V-ing.',
                                      style: TextStyle(
