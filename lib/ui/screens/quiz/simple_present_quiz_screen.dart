...
class SimplePresentQuizScreen extends StatefulWidget {
  const SimplePresentQuizScreen({super.key});

  @override
  State<SimplePresentQuizScreen> createState() =>
      _SimplePresentQuizScreenState();
}

class _SimplePresentQuizScreenState extends State<SimplePresentQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < simplePresentQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          simplePresentQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': simplePresentQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = simplePresentQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${simplePresentQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì hiện tại đơn dùng với các hành động thường xuyên, lặp đi lặp lại hoặc sự thật hiển nhiên. Động từ thêm -s/-es với ngôi thứ 3 số ít (he, she, it).',
                                      style: TextStyle(
