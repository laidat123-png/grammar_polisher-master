...
class PastPerfectContinuousQuizScreen extends StatefulWidget {
  const PastPerfectContinuousQuizScreen({super.key});

  @override
  State<PastPerfectContinuousQuizScreen> createState() =>
      _PastPerfectContinuousQuizScreenState();
}

class _PastPerfectContinuousQuizScreenState
    extends State<PastPerfectContinuousQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < pastPerfectContinuousQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          pastPerfectContinuousQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': pastPerfectContinuousQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion =
        pastPerfectContinuousQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${pastPerfectContinuousQuestions.length}',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${pastPerfectContinuousQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì quá khứ hoàn thành tiếp diễn dùng để diễn tả hành động đã xảy ra liên tục trong quá khứ trước một hành động khác. Cấu trúc: S + had been + V-ing. Thường đi với "for", "since", "when", "before".',
                                      style: TextStyle(
