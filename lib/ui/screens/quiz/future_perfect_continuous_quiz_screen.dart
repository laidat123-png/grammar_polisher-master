...
class FuturePerfectContinuousQuizScreen extends StatefulWidget {
  const FuturePerfectContinuousQuizScreen({super.key});

  @override
  State<FuturePerfectContinuousQuizScreen> createState() =>
      _FuturePerfectContinuousQuizScreenState();
}

class _FuturePerfectContinuousQuizScreenState
    extends State<FuturePerfectContinuousQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < futurePerfectContinuousQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          futurePerfectContinuousQuestions[_currentQuestionIndex]
              .correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': futurePerfectContinuousQuestions.length,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${futurePerfectContinuousQuestions.length}',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${futurePerfectContinuousQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì tương lai hoàn thành tiếp diễn dùng để diễn tả hành động sẽ xảy ra và tiếp tục trong một khoảng thời gian trước một thời điểm trong tương lai. Cấu trúc: S + will + have + been + V-ing. Thường đi với "for", "by then", "by the time".',
                                      style: TextStyle(
