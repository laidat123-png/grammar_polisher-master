...
class FutureSimpleQuizScreen extends StatefulWidget {
  const FutureSimpleQuizScreen({super.key});

  @override
  State<FutureSimpleQuizScreen> createState() => _FutureSimpleQuizScreenState();
}

class _FutureSimpleQuizScreenState extends State<FutureSimpleQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < futureSimpleQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          futureSimpleQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': futureSimpleQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = futureSimpleQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${futureSimpleQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì tương lai đơn dùng để diễn tả hành động sẽ xảy ra trong tương lai. Cấu trúc: S + will + V(nguyên thể). Thường đi với "tomorrow", "next week", "in the future".',
                                      style: TextStyle(
