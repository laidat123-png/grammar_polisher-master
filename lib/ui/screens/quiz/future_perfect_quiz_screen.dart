...
class FuturePerfectQuizScreen extends StatefulWidget {
  const FuturePerfectQuizScreen({super.key});

  @override
  State<FuturePerfectQuizScreen> createState() =>
      _FuturePerfectQuizScreenState();
}

class _FuturePerfectQuizScreenState extends State<FuturePerfectQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < futurePerfectQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          futurePerfectQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': futurePerfectQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = futurePerfectQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${futurePerfectQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì tương lai hoàn thành dùng để diễn tả hành động sẽ hoàn thành trước một thời điểm trong tương lai. Cấu trúc: S + will + have + V3/ed. Thường đi với "by the time", "by then", "before".',
                                      style: TextStyle(
