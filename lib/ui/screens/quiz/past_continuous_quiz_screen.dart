...
class PastContinuousQuizScreen extends StatefulWidget {
  const PastContinuousQuizScreen({super.key});

  @override
  State<PastContinuousQuizScreen> createState() =>
      _PastContinuousQuizScreenState();
}

class _PastContinuousQuizScreenState extends State<PastContinuousQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < pastContinuousQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          pastContinuousQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': pastContinuousQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = pastContinuousQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${pastContinuousQuestions.length}',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${pastContinuousQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì quá khứ tiếp diễn dùng để diễn tả hành động đang xảy ra tại một thời điểm cụ thể trong quá khứ. Cấu trúc: S + was/were + V-ing. Thường đi với "when", "while", "at that time".',
                                      style: TextStyle(
