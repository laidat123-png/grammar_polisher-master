...
class PresentPerfectQuizScreen extends StatefulWidget {
  const PresentPerfectQuizScreen({super.key});

  @override
  State<PresentPerfectQuizScreen> createState() =>
      _PresentPerfectQuizScreenState();
}

class _PresentPerfectQuizScreenState extends State<PresentPerfectQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < presentPerfectQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          presentPerfectQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': presentPerfectQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = presentPerfectQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${presentPerfectQuestions.length}',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${presentPerfectQuestions.length}',
                                  style: const TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
                                  ),
                            ...
                            if (_showHint)
                              Container(
                                padding: const EdgeInsets.all(
                                  16,
                                ), // Tăng padding từ 12 lên 16
                                decoration: BoxDecoration(
                                  color: Colors.amber[50],
                                  borderRadius: BorderRadius.circular(
                                    16,
                                  ), // Tăng bo góc từ 12 lên 16
                                  border: Border.all(
                                    color: Colors.amber,
                                    width: 1.5,
                                  ), // Tăng độ dày viền từ 1 lên 1.5
                                ),
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Icon(
                                          ...
                                          size: 20,
                                        ), // Tăng kích thước icon từ 16 lên 20
                                        const SizedBox(
                                          width: 6,
                                        ), // Tăng khoảng cách từ 4 lên 6
                                        Text(
                                          'Mẹo nhớ:',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                    ...
                                    const SizedBox(
                                      height: 8,
                                    ), // Tăng khoảng cách từ 4 lên 8
                                    Text(
                                      'Thì hiện tại hoàn thành dùng để diễn tả hành động đã xảy ra trong quá khứ và có kết quả hoặc ảnh hưởng đến hiện tại. Cấu trúc: S + have/has + V3/ed.',
                                      style: TextStyle(
