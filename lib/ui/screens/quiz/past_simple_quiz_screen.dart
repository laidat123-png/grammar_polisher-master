...
class PastSimpleQuizScreen extends StatefulWidget {
  const PastSimpleQuizScreen({super.key});

  @override
  State<PastSimpleQuizScreen> createState() => _PastSimpleQuizScreenState();
}

class _PastSimpleQuizScreenState extends State<PastSimpleQuizScreen> {
  ...
  void _nextQuestion() {
    setState(() {
      if (_currentQuestionIndex < pastSimpleQuestions.length - 1) {
  ...
  void _checkAnswer(String selectedAnswer) {
    ...
    setState(() {
      ...
      if (selectedAnswer ==
          pastSimpleQuestions[_currentQuestionIndex].correctAnswer) {
        _score++;
      }
    });
  ...
  void _showResultDialog() {
    ...
    final Map<String, dynamic> quizResult = {
      'score': _score,
      'totalQuestions': pastSimpleQuestions.length,
  ...
  Widget build(BuildContext context) {
    final currentQuestion = pastSimpleQuestions[_currentQuestionIndex];
    return PopScope(
      canPop: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  'Câu ${_currentQuestionIndex + 1}/${pastSimpleQuestions.length}',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Thì quá khứ đơn dùng để diễn tả hành động đã xảy ra và kết thúc trong quá khứ. Động từ thường thêm -ed hoặc có dạng bất quy tắc (V2). Ví dụ: walked, went, saw.',
                                      style: TextStyle(
